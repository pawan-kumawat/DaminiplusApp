...
class TopicsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final completedTopics = topics.where((tp) {
      final tc = tp['completedQuestions'] as int? ?? 0;
      final tt = tp['totalQuestions'] as int? ?? 0;
      return tt > 0 && tc >= tt;
    }).length;
        ...
        child: topics.isEmpty
            ...
            : ListView(
                ...
                children: [
                  ...
                  if (completedTopics > 0) ...[const SizedBox(height: 4)],
                ],
              ),
      ),
    );
  ...
  Future<void> _openSubscription(BuildContext context, String reason) async {
