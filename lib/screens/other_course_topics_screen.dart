...
import 'other_course_questions_screen.dart';
import 'other_course_subscription_screen.dart';

class OtherCourseTopicsScreen extends StatelessWidget {
      ...
      onTap: topicId.isEmpty
          ...
          : () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => OtherCourseQuestionsScreen(
                    otherCourseId: otherCourseId,
                    otherCourseName: otherCourseName,
                    otherCourseSubjectId: otherCourseSubjectId,
                    otherCourseSubjectName: otherCourseSubjectName,
                    topicId: topicId,
                    topicName: name,
                  ),
                ),
